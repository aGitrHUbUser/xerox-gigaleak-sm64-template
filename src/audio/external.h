...
// main_inc.h
#define Na_FixSeFlagEntry(s)    play_sound(s, gGlobalSoundSource);
#define Na_SystemTrgFixSeStart(s)    play_sound(s, gGlobalSoundSource);
#define objsound_level(s)    cur_obj_play_sound_1(s);
